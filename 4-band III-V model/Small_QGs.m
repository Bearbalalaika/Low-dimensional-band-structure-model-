...
LENS=1; % lens geometry 1=> lens type
SQR=0; 
...
if LENS
    ...
    C_QD = QD_lens(x0,y0,z0,QD_r,QD_r2, QD_t, asym,gauss, C_QD);
...
if SQR
    ...
    C_QD = QD_sqr(x0,y0,z0,QD_r,QD_r2, QD_t, asym,gauss, C_QD);
...
if Side_QWR_F
    ...
    C_QD =Side_QWR(x0,y0,z0,Side_QWR_r,Side_QWR_l, Side_QWR_alcont,Side_QWR_core_cont, asym,gauss);
end
